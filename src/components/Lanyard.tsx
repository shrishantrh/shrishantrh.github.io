...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false }: BandProps) {
  ...
  // Create a simple solid color for the lanyard band
  const bandColor = useMemo(() => new THREE.Color('#1a1a2e'), []);
